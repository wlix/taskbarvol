...
【インストール】
全てのファイルを本体のインストールフォルダ以下の場所に配置してください。
...
【使用方法】
本体を起動し、タスクバー上でホイールを回してください。
設定の詳細はiniファイルを参照してください。
...
peach を 公開されている U さん、TTBaseCpp の作者さん、TaskBarVol を公開されたutymさんを始め、
